        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex items-center justify-between h-20 md:h-28">
            ...
            <div className="flex items-center gap-4 flex-1 justify-end">
              ...
              <button aria-label="Open search" className="p-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full transition-colors text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User account menu" className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group">
