            ...
            <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close mobile menu" className="p-2 hover:bg-gray-50 rounded-full transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none" onClick={() => setIsMobileMenuOpen(false)}>
