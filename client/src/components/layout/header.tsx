            ...
            <nav className="hidden lg:flex items-center gap-6 text-sm font-medium tracking-wide flex-1 justify-start pr-40">
              {[
                ...
                <Link
                  key={item.name}
                  href={item.href}
                  className="relative py-2 text-gray-600 hover:text-primary transition-colors group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-sm"
                >
                  {item.name}
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User menu" className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
            ...
            <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close menu" onClick={() => setIsMobileMenuOpen(false)} className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full p-1">
