      ...
      >
        <div className="container mx-auto px-4 relative">
          <div className="flex items-center justify-between h-20 md:h-28">
            {/* Mobile Menu Button */}
            <button
              aria-label="Open mobile menu" className="md:hidden p-2 hover:bg-gray-50 rounded-full transition-colors z-50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
            ...
            <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close mobile menu" onClick={() => setIsMobileMenuOpen(false)} className="focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
