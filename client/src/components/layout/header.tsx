    ...
    <>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex items-center justify-between h-20 md:h-28">
            ...
            <button
              ...
              className="md:hidden p-2 hover:bg-gray-50 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors z-50"
            ...
            <div className="flex items-center gap-4 flex-1 justify-end">
              ...
              <button aria-label="Search" className="p-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary">
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User account menu" className="p-2 hover:bg-gray-50 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-colors text-gray-600 hover:text-primary relative group">
            ...
            <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close mobile menu" className="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full p-1" onClick={() => setIsMobileMenuOpen(false)}>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="flex items-center gap-2 px-4 py-3 bg-white/90 dark:bg-black/90 backdrop-blur-md rounded-full border border-gray-200 dark:border-white/10 shadow-2xl hover:scale-105 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary transition-all duration-300 group"
        >
          {theme === 'dark' ? (
            <>
