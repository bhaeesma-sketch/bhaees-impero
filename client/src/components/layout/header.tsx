              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User profile" className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary">
