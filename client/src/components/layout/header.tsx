    ...
    <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button
                    ...
                    className="p-1 rounded-md hover:bg-gray-100 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                    onClick={() => setIsMobileMenuOpen(false)}
                  >
                  ...
                  <nav className="flex flex-col">
                    ...
                    {!user ? (
                      ...
                      <button
                        ...
                        className="px-6 py-4 text-lg font-medium text-red-600 text-left hover:bg-gray-50 transition-colors focus-visible:outline-none focus-visible:bg-gray-50 focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-primary"
                      >
                        Sign Out
                      </button>
                    )}
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          onClick={toggleTheme}
          className="flex items-center gap-2 px-4 py-3 bg-white/90 dark:bg-black/90 backdrop-blur-md rounded-full border border-gray-200 dark:border-white/10 shadow-2xl hover:scale-105 transition-all duration-300 group focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
        >
          {theme === 'dark' ? (
            <>
