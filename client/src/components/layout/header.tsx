    ...
    <>
        ...
        <div className="container mx-auto px-4 relative">
          <div className="flex items-center justify-between h-20 md:h-28">
            ...
            <button
              ...
              className="md:hidden p-2 hover:bg-gray-50 rounded-full transition-colors z-50 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
            ...
            <div className="flex items-center gap-4 flex-1 justify-end">
              ...
              <button aria-label="Search" className="p-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full transition-colors text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User account menu" className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
            ...
            <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close mobile menu" className="p-2 rounded-full hover:bg-gray-100 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none" onClick={() => setIsMobileMenuOpen(false)}>
                  ...
                  <nav className="flex flex-col">
                    ...
                    {!user ? (
                      ...
                      <button
                        ...
                        className="px-6 py-4 text-lg font-medium text-red-600 text-left hover:bg-gray-50 transition-colors focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
                      >
                        Sign Out
                      </button>
                    )}
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          onClick={toggleTheme}
          className="flex items-center gap-2 px-4 py-3 bg-white/90 dark:bg-black/90 backdrop-blur-md rounded-full border border-gray-200 dark:border-white/10 shadow-2xl hover:scale-105 transition-all duration-300 group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none"
        >
          {theme === 'dark' ? (
            <>
