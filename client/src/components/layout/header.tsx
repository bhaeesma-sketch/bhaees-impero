      ...
      >
        <div className="container mx-auto px-4 relative">
          <div className="flex items-center justify-between h-20 md:h-28">
            {/* Mobile Menu Button */}
            <button
              className="md:hidden p-2 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full transition-colors z-50"
            ...
            <div className="flex items-center gap-4 flex-1 justify-end">
              ...
              <button
                className="p-2 hover:bg-gray-50 dark:hover:bg-gray-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full transition-colors text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary"
                aria-label="Search"
              >
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button
                      className="p-2 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full transition-colors text-gray-600 hover:text-primary relative group"
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button
                    ...
                    className="p-2 -m-2 hover:bg-gray-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full transition-colors"
                  >
