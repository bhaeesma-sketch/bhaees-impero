          ...
          <div className="flex items-center justify-between h-20 md:h-28">
            ...
            <div className="flex items-center gap-4 flex-1 justify-end">
              ...
              <button aria-label="Search"
                className="p-2 hover:bg-gray-50 dark:hover:bg-gray-800 rounded-full transition-colors text-gray-600 dark:text-gray-300 hover:text-primary dark:hover:text-primary focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User account"
                      className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close menu"
                    onClick={() => setIsMobileMenuOpen(false)}
                    className="focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-full">
