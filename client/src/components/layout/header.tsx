    ...
    <>
              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User menu" className="p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none">
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <button
          ...
          className="focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none flex items-center gap-2 px-4 py-3 bg-white/90 dark:bg-black/90 backdrop-blur-md rounded-full border border-gray-200 dark:border-white/10 shadow-2xl hover:scale-105 transition-all duration-300 group"
        >
          {theme === 'dark' ? (
            <>
