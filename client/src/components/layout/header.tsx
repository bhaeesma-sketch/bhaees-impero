              ...
              {user ? (
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button aria-label="User account" className="focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none p-2 hover:bg-gray-50 rounded-full transition-colors text-gray-600 hover:text-primary relative group">
