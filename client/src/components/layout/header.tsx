            ...
            <>
              ...
              >
                <div className="p-6 flex items-center justify-between border-b border-gray-100">
                  ...
                  <button aria-label="Close menu" className="focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none rounded-sm" onClick={() => setIsMobileMenuOpen(false)}>
