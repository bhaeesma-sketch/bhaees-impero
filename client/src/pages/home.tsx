    ...
    <div className="min-h-screen bg-background text-foreground font-sans selection:bg-primary/20 overflow-x-hidden">
        ...
        <div className="container mx-auto px-4 space-y-24">
          ...
          <div>
            <div className="flex justify-between items-end mb-8 border-b border-gray-100 dark:border-gray-800 pb-4">
              <div>
                <h2 className="font-serif text-3xl md:text-5xl text-gray-900 dark:text-white mb-2">Gold Bullion</h2>
                <p className="text-gray-500 dark:text-gray-400 font-light tracking-wide uppercase text-sm">Investment Grade Coins & Bars</p>
              </div>
              <Link href="/catalog?category=coins">
                <Button variant="ghost" className="hidden md:flex text-primary hover:text-primary/80">View All Gold <ArrowRight className="ml-2 w-4 h-4" /></Button>
              </Link>
            </div>
            <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {PRODUCTS.filter(p => p.category === 'coins' || p.category === 'bars').slice(0, 4).map(p => (
          ...
          <div>
            <div className="flex justify-between items-end mb-8 border-b border-gray-100 dark:border-gray-800 pb-4">
              <div>
                <h2 className="font-serif text-3xl md:text-5xl text-gray-900 dark:text-white mb-2">Platinum Bullion</h2>
                <p className="text-gray-500 dark:text-gray-400 font-light tracking-wide uppercase text-sm">Premium PAMP Suisse Collection</p>
              </div>
              <Link href="/catalog?category=platinum">
                <Button variant="ghost" className="hidden md:flex text-primary hover:text-primary/80">View Platinum <ArrowRight className="ml-2 w-4 h-4" /></Button>
              </Link>
            </div>
            <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {PRODUCTS.filter(p => p.category === 'platinum').map(p => (
                <StaggerItem key={p.id}>
                  <ProductCard
                    id={p.id}
                    name={p.name}
          ...
          <div>
            <div className="flex justify-between items-end mb-8 border-b border-gray-100 dark:border-gray-800 pb-4">
              <div>
                <h2 className="font-serif text-3xl md:text-5xl text-gray-900 dark:text-white mb-2">Silver Bullion</h2>
                <p className="text-gray-500 dark:text-gray-400 font-light tracking-wide uppercase text-sm">Pure Silver Coins & Bars</p>
              </div>
              <Link href="/catalog?category=silver">
                <Button variant="ghost" className="hidden md:flex text-primary hover:text-primary/80">View Silver <ArrowRight className="ml-2 w-4 h-4" /></Button>
              </Link>
            </div>
            <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {PRODUCTS.filter(p => p.category === 'silver').slice(0, 4).map(p => (
                <StaggerItem key={p.id}>
                  <ProductCard
                    id={p.id}
                    name={p.name}
          ...
          <div>
            <div className="flex justify-between items-end mb-8 border-b border-gray-100 dark:border-gray-800 pb-4">
              <div>
                <h2 className="font-serif text-3xl md:text-5xl text-gray-900 dark:text-white mb-2">High Jewelry</h2>
                <p className="text-gray-500 dark:text-gray-400 font-light tracking-wide uppercase text-sm">Exquisite Handcrafted Pieces</p>
              </div>
              <Link href="/catalog?category=jewelry">
                <Button variant="ghost" className="hidden md:flex text-primary hover:text-primary/80">View Jewelry <ArrowRight className="ml-2 w-4 h-4" /></Button>
              </Link>
            </div>
            <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
              {PRODUCTS.filter(p => p.category === 'jewelry').slice(0, 4).map(p => (
                <StaggerItem key={p.id}>
                  <ProductCard
                    id={p.id}
                    name={p.name}
      ...
      <section className="py-20 bg-white dark:bg-black transition-colors duration-500">
        <div className="container mx-auto px-4">
          <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gray-100 dark:bg-gray-800 border border-gray-100 dark:border-gray-800">
            {[
              ...
              <StaggerItem
                key={i}
                className="bg-white dark:bg-black p-10 flex flex-col items-center text-center group cursor-default transition-all duration-300 hover:z-10 hover:shadow-xl dark:hover:shadow-primary/10"
              >
                <item.icon className="w-8 h-8 text-gray-300 dark:text-gray-600 group-hover:text-primary transition-colors duration-300 mb-6 transform group-hover:scale-110" strokeWidth={1} />
                <h3 className="font-serif font-medium text-lg text-gray-900 dark:text-white mb-2">{item.title}</h3>
                <p className="text-xs text-gray-500 dark:text-gray-400 font-medium tracking-wide uppercase">{item.desc}</p>
              </StaggerItem>
            ))}
          </StaggerContainer>
        </div>
      ...
      <footer className="bg-white dark:bg-black border-t border-gray-100 dark:border-gray-800 pt-24 pb-12 relative overflow-hidden transition-colors duration-500">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid md:grid-cols-4 gap-16 mb-16">
            <div className="space-y-6">
              <div className="space-y-1">
                <div className="mb-6">
                  <img src={logoImg} alt="Impero Di Gold Logo" className="h-40 w-auto object-contain brightness-100 dark:brightness-0 dark:invert" />
                </div>
              </div>
            ...
            <Reveal delay={0.1}>
              <div>
                <h4 className="font-serif text-lg mb-6 text-gray-900 dark:text-white">Collections</h4>
            ...
            <Reveal delay={0.2}>
              <div>
                <h4 className="font-serif text-lg mb-6 text-gray-900 dark:text-white">Client Care</h4>
                <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400 font-light">
            ...
            <Reveal delay={0.3}>
              <div>
                <h4 className="font-serif text-lg mb-6 text-gray-900 dark:text-white">Contact Us</h4>
                <ul className="space-y-4 text-sm text-gray-500 dark:text-gray-400 font-light">
                  <li>
                    <span className="block font-medium text-gray-900 dark:text-white mb-1">Headquarters</span>
                    Gold Souq, Deira<br />Dubai, United Arab Emirates
                  </li>
                  <li>
                    <span className="block font-medium text-gray-900 dark:text-white mb-1">Phone</span>
          ...
          <div className="border-t border-gray-100 dark:border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-gray-400 font-light tracking-wide">
